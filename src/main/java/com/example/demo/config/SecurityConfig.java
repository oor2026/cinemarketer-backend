...
public class SecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET,
                                ...
                                "/api/publications/*/reactions/count",
                                "/api/publications/*/comments/count"
                        ).permitAll()
                        .requestMatchers(
                                "/api/auth/register",
                                "/api/auth/login",
                                ...
                                "/api/self-service/request-link",
                                "/api/self-service/verify-redirect",
                                "/api/self-service/exchange",
                                "/api/banners",
                                "/api/faq",
                                "/api/public/**",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setExposedHeaders(Arrays.asList("X-Total-Replies", "X-Has-More"));
